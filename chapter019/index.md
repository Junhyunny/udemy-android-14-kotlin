...
> 학습 TODO: [액티비티와 화면의 관계](../todos/017-android-activity-and-screen.md)
...
> 학습 TODO: [`onCreate`와 `super.onCreate`의 역할](../todos/018-activity-oncreate-and-super.md)
...
> 학습 TODO: [`@Composable`과 재구성](../todos/025-composable-annotation-and-recomposition.md)
