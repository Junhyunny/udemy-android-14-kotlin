...
→ [`android-navigation-backstackentry-savedstatehandle.md`](android-navigation-backstackentry-savedstatehandle.md)
...
→ [`android-navigation-navargument-setup.md`](android-navigation-navargument-setup.md)
...
→ [`compose-modal-bottom-sheet-state-and-sheetstate.md`](compose-modal-bottom-sheet-state-and-sheetstate.md)에서 다룬 "컴포지션 존재 여부 vs 애니메이션"과 비슷한 층위 구분이다.
...
→ [`kotlin-sealed-class-and-interface.md`](kotlin-sealed-class-and-interface.md), [`android-navigation-string-route-vs-type-safe.md`](android-navigation-string-route-vs-type-safe.md)
