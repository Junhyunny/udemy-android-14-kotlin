...
→ [`compose-localcontext.md`](compose-localcontext.md)에서 다룬 `CompositionLocal`과 같은 메커니즘이다.
...
→ [`android-resources-r-class-and-compose-theme.md`](android-resources-r-class-and-compose-theme.md)
