...
- `plugins`: 이 모듈에 적용할 플러그인. `com.android.application`을 적용해 안드로이드 앱 모듈로 만든다. 자세한 내용은 [`009-android-application-plugin-role.md`](009-android-application-plugin-role.md)를 참고한다.
