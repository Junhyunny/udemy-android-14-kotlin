...
**컴포저블이 아닌 콜백에서 코루틴을 시작할 때.** → [`053-kotlin-coroutine-scope-concept.md`](053-kotlin-coroutine-scope-concept.md)
...
`AddEditDetailView`가 첫 번째 형태다. → [`048-android-viewmodel-encapsulation-and-async-timing.md`](048-android-viewmodel-encapsulation-and-async-timing.md)
