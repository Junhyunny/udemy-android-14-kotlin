...
문제의 내용 자체는 [`010-android-agp-kgp-and-compiler-plugins.md`](010-android-agp-kgp-and-compiler-plugins.md)에, 빌드 파일 구조는 [`007-gradle-version-catalog-and-build-files.md`](007-gradle-version-catalog-and-build-files.md)에 있다.
