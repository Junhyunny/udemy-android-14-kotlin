...
4. 해당 스코프가 무효화되고 다음 프레임에 재구성된다. 자세한 과정은 [`036-compose-recomposition-timing-and-scope.md`](036-compose-recomposition-timing-and-scope.md)에 정리했다.
...
추가·삭제·편집이 일어나는 목록이므로 키를 주는 편이 안전하다. 자세한 이유는 [`038-compose-list-item-key.md`](038-compose-list-item-key.md)에 정리했다.
