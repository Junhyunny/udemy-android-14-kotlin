...
- **Room의 `@Dao`와 헷갈리기 쉬운데 방식이 완전히 다르다.** 둘 다 "인터페이스만 쓰면 동작한다"는 경험은 같지만 원리가 정반대다.
  ...
  → [`061-android-room-dao-code-generation.md`](061-android-room-dao-code-generation.md)
...
→ [`052-kotlin-coroutines-continuation-state-machine.md`](052-kotlin-coroutines-continuation-state-machine.md)
...
→ [`004-kotlin-by-lazy-delegate.md`](004-kotlin-by-lazy-delegate.md)
...
→ [`049-android-repository-single-source-of-truth.md`](049-android-repository-single-source-of-truth.md)
...
→ [`063-android-api-key-secure-management.md`](063-android-api-key-secure-management.md)
