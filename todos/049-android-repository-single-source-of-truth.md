...
불변 데이터로 노출하면 변경 경로가 저장소의 공개 함수로 한정되고, Compose의 재구성 판정에도 유리하다. 관련 내용은 [`037-compose-state-list-reference-change.md`](037-compose-state-list-reference-change.md)에 정리했다.
